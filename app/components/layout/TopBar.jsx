...
const TopBar = () => {
  ...
  return (
    <div className='flex justify-between items-center mt-6'>
      ...
      <button className='create-post-btn' onClick={()=>{router.push('/create-post')}}><Add/><p>Create Post</p> </button>
      ...
      <div className='flex gap-3'>
        ...
        <Link href='/'>
          <Image src='/assets/logo.png' alt='profile pic' width={50} height={50} className='rounded-full md:hidden'/>
        </Link> 
      </div>
